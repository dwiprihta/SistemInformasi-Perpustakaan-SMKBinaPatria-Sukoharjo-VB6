...
Begin VB.Form data_anggota 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "DATA ANGGOTA PERPUSTAKAAN (SISWA)"
   ClientHeight    =   10920
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   20400
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "data_anggota.frx":0000
      Height          =   3615
      Left            =   360
      TabIndex        =   1
      Top             =   6960
   ...
   End
End
Attribute VB_Name = "data_anggota"
...
Sub query()
Adodc1.Recordset.Filter = "kelas like '%x%'"
...
.Columns(4).Caption = "NO INDUK SISWA"
